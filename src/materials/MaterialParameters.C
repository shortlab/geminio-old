...
Real
energy(int s,std::string species, std::string Etype)
{
  //unit:eV
  Real E=0.0;
...
Real
D_prefactor(int /*s*/, std::string /*species*/)
{
...
//size S1 and S2
Real
absorb(int S1, int S2, std::string C1, std::string C2,Real T, int tag1, int tag2)
{
...
Real
emit(int S1, int S2, Real T, std::string C1, std::string /*C2*/, int tag1, int tag2)
{
